    ...
    <section id="experience" className="experience container">
      ...
      <div className="grid">
        <article className="card">
          ...
          <p>
            Analyzed student performance using PivotTables and formulas to
        ...
        <article className="card">
          ...
          <p>
            Built relational tables in Access and created monthly
            summaries/exportable reports in Excel.
          </p>
        </article>
